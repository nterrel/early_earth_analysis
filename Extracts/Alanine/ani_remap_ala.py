...
serialized_graph = mol_data[mol_data['name'] == 'Alanine']['graph'].item()
...
structures, comments = read_xyz_file('ani_alanine_formula.xyz')
...
write_xyz_file('reordered_ani_alanines.xyz', reordered_structures)
write_xyz_file_failed('failed_ani_ala_coord_remap.xyz', failed_structures)
