#!/bin/bash
#SBATCH --job-name=modified_top_loader_molfind      # Job name
#SBATCH --output=top_loader_molfind_%j.out          # Output file
#SBATCH --error=top_loader_molfind_%j.err           # Error file
...
cumolfind-molfind /red/roitberg/nick_analysis/Trimmed_frames/trimmed_1608-1629_1.2ns.dcd \
                  ...
                  --dump_interval=50 \
                  --timestep=0.25 \
                  --output_dir=/red/roitberg/nick_analysis/molfind_modified_timing/topology_loader
