#!/bin/bash
#SBATCH --job-name=re48906293_molfind                 # Job name
#SBATCH --output=/red/roitberg/nick_analysis/re48906293_molfind_%j.out            # Output file
#SBATCH --error=/red/roitberg/nick_analysis/re48906293_molfind_%j.err             # Error file
...
cumolfind-molfind /red/roitberg/22M_20231222_prodrun/2023-12-24-094959.618385_1.4ns.dcd \
