#!/bin/bash
#SBATCH --job-name=re48907042_molfind                 # Job name
#SBATCH --output=/red/roitberg/nick_analysis/re48907042_molfind_%j.out            # Output file
#SBATCH --error=/red/roitberg/nick_analysis/re48907042_molfind_%j.err             # Error file
