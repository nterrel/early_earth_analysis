#!/bin/bash
#SBATCH --job-name=re48906671_molfind                 # Job name
#SBATCH --output=/red/roitberg/nick_analysis/re48906671_molfind_%j.out            # Output file
#SBATCH --error=/red/roitberg/nick_analysis/re48906671_molfind_%j.err             # Error file
...
cumolfind-molfind /red/roitberg/22M_20231222_prodrun/2023-12-28-073439.757187_2.7ns.dcd \
