...
dcd_file = '/red/roitberg/nick_analysis/96_atom_frame.dcd'
...
def main(df, topology):
    ...
    output_file_name = f'/red/roitberg/nick_analysis/96_atom_coords.h5'
...
if __name__ == "__main__":
    df = pd.read_parquet('/red/roitberg/nick_analysis/96_atom_frame_seg0000of0001_molecule.pq')
