#!/bin/bash
#SBATCH --job-name=molfind_196366_quenched                 # Job name
#SBATCH --output=/red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_196366/molfind_196366_quenched_%j.out            # Output file
#SBATCH --error=/red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_196366/molfind_196366_quenched_%j.err             # Error file
...
cumolfind-molfind /red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_196366/logs/2024-09-03-144244.920253_196366_quench.dcd \
                  ...
                  --dump_interval=50 \
                  --timestep=0.25 \
                  --output_dir=/red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_196366/quench_analyze \
                  --num_segments=21 \
                  --segment_index=20
