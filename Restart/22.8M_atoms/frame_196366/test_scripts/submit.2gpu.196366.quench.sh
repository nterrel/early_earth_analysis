#!/bin/bash
#SBATCH --job-name=lammps_ani_2gpu	 # Job name
...
#SBATCH --mem=256gb                  # Memory (i.e. RAM) per node
#SBATCH --exclude=c0900a-s11
#SBATCH --mail-type=END,FAIL         # Mail events (NONE, BEGIN, END, FAIL, ALL)
#SBATCH --mail-user=nterrel@ufl.edu  # Where to send mail
#SBATCH --time=100:00:00             # Wall time limit (days-hrs:min:sec)
#SBATCH --output=lammps_ani_22M_quench_2gpu_%j.log   # Path to the standard output and error files relative to the working dir
