#!/bin/bash
#SBATCH --job-name=lammps_ani_4gpu	 # Job name
...
#SBATCH --output=lammps_ani_22M_quench_4gpu_%j.log   # Path to the standard output and error files relative to the working dir
