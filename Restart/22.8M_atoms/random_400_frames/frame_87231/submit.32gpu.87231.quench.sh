#!/bin/bash
#SBATCH --job-name=lammps_ani_87231
#SBATCH --ntasks=32
#SBATCH --nodes=4
...
#SBATCH --output=lammps_ani_87231_%j.log
...
python /red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/run_22.8M_quench.py \
    /red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/frame_87231/frame_87231.data \
    --kokkos \
    --num_gpus=32 \
    --input_file=/red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/in.22M.quench.lammps \
    --log_dir=/red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/frame_87231/logs \
    --ani_model_file='ani1x_nr.pt' \
    --run_name=early_earth_22M_87231_quench \
    --ani_num_models=8 \
    --timestep=0.25 \
    --run_steps=1000 \
    --run
