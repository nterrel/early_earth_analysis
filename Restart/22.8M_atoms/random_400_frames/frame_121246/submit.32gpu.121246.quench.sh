#!/bin/bash
#SBATCH --job-name=lammps_ani_121246        # Job name
...
#SBATCH --output=lammps_ani_121246_%j.log   # Path to the standard output and error files relative to the working dir
...
python /red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/run_22.8M_quench.py     /red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/frame_121246/frame_121246.data     --kokkos     --num_gpus=32     --input_file=/red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/in.22M.quench.lammps     --log_dir=/red/roitberg/nick_analysis/Restart/22.8M_atoms/random_400_frames/frame_121246/logs     --ani_model_file='ani1x_nr.pt'     --run_name=early_earth_22M_121246_quench     --ani_num_models=8     --timestep=0.25     --run_steps=1000     --run
