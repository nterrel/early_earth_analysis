#!/bin/bash
#SBATCH --job-name=molfind_256780_quenched                 # Job name
#SBATCH --output=/red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_256780/molfind_256780_quenched_%j.out            # Output file
#SBATCH --error=/red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_256780/molfind_256780_quenched_%j.err             # Error file
...
cumolfind-molfind /red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_256780/logs/2024-09-05-173918.390832_256780_quench.dcd \
                  ...
                  --dump_interval=50 \
                  --timestep=0.25 \
                  --output_dir=/red/roitberg/nick_analysis/Restart/22.8M_atoms/frame_256780/quench_analyze \
                  --num_segments=21 \
                  --segment_index=20
