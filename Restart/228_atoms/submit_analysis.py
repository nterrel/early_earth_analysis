...
def main():
    parser = argparse.ArgumentParser(
        description="Parallelize cumolfind analysis.")
    ...
    if os.path.isfile(args.traj):
        ...
        traj_files = sorted([os.path.join(args.traj, f)
                            for f in os.listdir(args.traj) if f.endswith('.dcd')])
    ...
    for traj_file in traj_files:
        ...
        if match:
            ...
            print(
                f"Submitting job for {traj_filename}, time_offset={time_offset}")
