...
#SBATCH --gres=gpu:24
#SBATCH --mem=16gb                  # Memory (i.e. RAM) per processor
#SBATCH --mail-type=END,FAIL         # Mail events (NONE, BEGIN, END, FAIL, ALL)
#SBATCH --mail-user=nterrel@ufl.edu # Where to send mail
#SBATCH --time=03:00:00             # Wall time limit (days-hrs:min:sec)
#SBATCH --output=lammps_ani_22M_30gpu_%j.log   # Path to the standard output and error files relative to the working dir
...
module load gcc/9.3.0 openmpi/4.1 cmake/3.21.3 git/2.30.1 
...
# restart 
python run_22.8M_quench.py \
       	frame_24221.data \
       	--kokkos \
	--num_gpus=30 \
	--input_file='in.22M.quench.lammps' \
	--log_dir=/red/roitberg/nick_analysis/Restart/FastQuench/test_fast_quench \
